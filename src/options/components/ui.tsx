/**
 * Shared presentational atoms for the Options Workspace, matching the app's dark
 * institutional theme (ink/surface/panel/border + gain/loss/warn/info tokens).
 * Every panel composes these so the terminal feels like one product.
 */
